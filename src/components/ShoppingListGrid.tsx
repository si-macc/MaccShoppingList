  ...
  return (
    <div>
        ...
        {SECTOR_LAYOUT.map((row, rowIndex) => (
          <div key={rowIndex} className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {row.map((sector) => {
              ...
              return (
                <div key={sector} className="bg-white rounded-lg shadow-md border-2 border-gray-200 overflow-hidden">
                  {/* Sector Header */}
                        ...
                        return (
                          <label
                            ...
                            className={`px-4 py-3 flex items-start space-x-3 cursor-pointer hover:bg-gray-50 transition ${
                              isChecked ? 'bg-gray-50 opacity-50' : ''
                            }`}
                          >
                            <input
                              type="checkbox"
      ...
      {showSaveModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl max-w-md w-full p-6">
            <h3 className="text-xl font-bold text-gray-900 mb-4">Save Shopping List</h3>
            <input
              type="text"
              value={listName}
      ...
      {showShareModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl max-w-md w-full p-6">
            <h3 className="text-xl font-bold text-gray-900 mb-4">Share Shopping List</h3>
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full px-4 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-100 transition"
              >
                Cancel
              </button>
            </div>
