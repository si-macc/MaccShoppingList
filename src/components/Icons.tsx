// Simple SVG icons matching FontAwesome style
// These are flat, single-color icons that inherit the current text color
...
export function LoadingIcon({ className = "w-5 h-5" }: IconProps) {
  return (
...
export function SaveIcon({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 3v4h6V3" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 17h6v4H9v-4z" />
    </svg>
  )
}
